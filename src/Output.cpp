...
#define PAIR_TYPE std::pair<Unit, const char*>
		...
		static std::array<PAIR_TYPE, 21> testUnits
		{{
			PAIR_TYPE { s,             "s"     },
			PAIR_TYPE { s^2,           "s²"    },
			PAIR_TYPE { h,             "h"     },
...
#undef PAIR_TYPE
		...
		static std::unordered_map<Unit, const char*> unit_names =
		{
			...
			{ av::ounce            , "oz"    },
			{ av::pound            , "lb"    },
			{ av::hundredweight    , "cwt"   },
			{ av::longhundredweight, "cwt"   },
			{ av::ton              , "t"     },
			{ av::longton          , "l. tn" },
			{ av::stone            , "st"    },
			{ av::poundal          , "pdl"   },
			...
			{ Metric::tbsp,        "tbsp"  },
			{ Metric::tsp,         "tsp"   },
			{ Metric::floz,        "fl oz" }, // Review: fl. Oz. is better?
			{ Metric::cup,         "cup"   },
			{ Metric::cup_uslegal, "cup"   },
			{ Metric::carat,       "ct"    },
			...
			{ Distance::parsec,     "pc"     },
			{ Distance::arpent_us,  "arpent" },
			{ Distance::arpent_fr,  "arpent" },
			{ Distance::xu,         "xu"     },
			...
			{ Pressure::mmHg,    "mmHg"         },
			{ Pressure::torr,    "torr"         },
			{ Pressure::inH2O, u8"inH\u2082O"   },
			{ Pressure::mmH2O, u8"mmH\u2082O"   },
			{ Pressure::atm,     "atm"          },
...
//			{ Power::VA,  "VA"    },
			...
			{ Energy::quad,      "Quad"            },
			{ Energy::therm_us,  "Therm [US]"      },
			{ Energy::therm_br,  "Therm [GB]"      },
			{ Energy::therm_ec,  "Therm [ISO]"     },
			{ Energy::ton_tnt,   "t"               },
			{ Energy::boe,       "BOE"             },
			{ Energy::foeb,      "FOEB"            },
			{ Energy::hartree, u8"E\u2095"         },
			{ Energy::tonhour, u8"ton\u2219h"      },

			// Textile
			{ Textile::tex,    "tex"    },
			{ Textile::denier, "den"    },
			{ Textile::span,   "span"   }, // Review
			{ Textile::finger, "finger" }, // Review
			{ Textile::nail,   "nail"   }, // Review

			// Clinical
			{ Clinical::pru,             "PRU"    },
			{ Clinical::woodu,           "WU"     },
			{ Clinical::diopter,         "dpt"    },
			{ Clinical::prism_diopter, u8"\u0394" },
			{ Clinical::mesh,            "mesh"   },
			{ Clinical::charriere,       "Fr"     },
			{ Clinical::drop,            "gt"     },
			{ Clinical::met,             "MET"    },
